...
name: payload-cms
description: >-
  Expert Payload CMS development patterns and best practices.
  Use when implementing collections, access control, hooks, queries, components, or custom endpoints.
  Invoke with @payload-cms in Antigravity.
---

# Payload CMS Skill

Expert development patterns for Payload CMS with TypeScript.

## When to Use

- Creating or modifying Payload CMS collections
- Implementing access control and RBAC
- Writing hooks (beforeChange, afterChange, etc.)
- Building custom admin components
- Writing queries with Local API
- Creating custom endpoints
- Database/storage adapter configuration
